...
HD_PWD='C:/Users/hp/Desktop/btech/sem 5/verification/Dual_Port_Ram/Dual_Port_Ram.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DualPortRAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DualPortRAM.tcl
