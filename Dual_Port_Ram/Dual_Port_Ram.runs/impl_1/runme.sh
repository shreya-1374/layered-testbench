...
HD_PWD='C:/Users/hp/Desktop/btech/sem 5/verification/Dual_Port_Ram/Dual_Port_Ram.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DualPortRAM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DualPortRAM.tcl -notrace
